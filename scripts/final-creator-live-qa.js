/**
 * [최종 실전 점검 - Creator] ⚠ 실제 AI 요금이 발생합니다
 *
 * 비개발자를 위한 설명:
 * - 배포 전에 인스타그램 카드와 유튜브 영상 제작이 실제로 되는지 확인합니다.
 *   AI를 진짜로 호출하므로 요금이 발생합니다.
 * - 기본적으로는 '만들기'까지만 하고 인스타그램에 올리지는 않습니다.
 *   실제 발행까지 확인하려면 --publish-instagram 옵션을 붙여야 합니다.
 *   (실수로 게시물이 올라가는 것을 막기 위한 장치입니다)
 */
